...
var getBlockButtonVariantProp = function (prop) { return function (_a) {
    var theme = _a.theme, _b = _a.variant, variant = _b === void 0 ? variants.PRIMARY : _b;
    return theme.blockButton[variant][prop];
}; };
var StyledBlockButton = styled.button(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  align-items: center;\n  background-color: ", ";\n  color: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  height: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  transition: background-color 0.2s;\n  opacity: ", ";\n  border: ", ";\n  transition: all 0.2s ease;\n  transform: translate3d(0, 0, 0);\n  text-transform: uppercase;\n  box-shadow: 0 0 0 0 ", ";\n\n  ", "\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    transform: translate3d(10px, -10px, 0);\n    z-index: 1;\n    box-shadow: 0px 0px 0 ", ",\n      -1px 1px 0 ", ", -2px 2px 0 ", ",\n      -3px 3px 0 ", ", -4px 4px 0 ", ",\n      -5px 5px 0 ", ", -6px 6px 0 ", ",\n      -7px 7px 0 ", ", -8px 8px 0 ", ",\n      -9px 9px 0 ", ", -10px 10px 0 ", ";\n  }\n\n  &:focus:not(:active) {\n    // box-shadow: 0 0 0 2px ", ";\n  }\n\n  &:active {\n    // background-color: ", ";\n    // box-shadow: ", ";\n  }\n\n  ", "\n  ", "\n  ", "\n"], ["\n  align-items: center;\n  background-color: ", ";\n  color: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  height: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  transition: background-color 0.2s;\n  opacity: ", ";\n  border: ", ";\n  transition: all 0.2s ease;\n  transform: translate3d(0, 0, 0);\n  text-transform: uppercase;\n  box-shadow: 0 0 0 0 ", ";\n\n  ",
    "\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    transform: translate3d(10px, -10px, 0);\n    z-index: 1;\n    box-shadow: 0px 0px 0 ", ",\n      -1px 1px 0 ", ", -2px 2px 0 ", ",\n      -3px 3px 0 ", ", -4px 4px 0 ", ",\n      -5px 5px 0 ", ", -6px 6px 0 ", ",\n      -7px 7px 0 ", ", -8px 8px 0 ", ",\n      -9px 9px 0 ", ", -10px 10px 0 ", ";\n  }\n\n  &:focus:not(:active) {\n    // box-shadow: 0 0 0 2px ", ";\n  }\n\n  &:active {\n    // background-color: ", ";\n    // box-shadow: ", ";\n  }\n\n  ", "\n  ", "\n  ", "\n"])), getBlockButtonVariantProp("background"), getBlockButtonVariantProp("color"), function (_a) {
...
}, getBlockButtonVariantProp("border"), getBlockButtonVariantProp("boxShadow"), function (_a) {
    var isActive = _a.isActive; _a.theme;
    return isActive &&
        "z-index: 1;\n    box-shadow: 0px 0px 0 " + getBlockButtonVariantProp("boxShadow") + ",\n    -1px 1px 0 " + getBlockButtonVariantProp("boxShadow") + ", -2px 2px 0 " + getBlockButtonVariantProp("boxShadow") + ",\n    -3px 3px 0 " + getBlockButtonVariantProp("boxShadow") + ", -4px 4px 0 " + getBlockButtonVariantProp("boxShadow") + ",\n    -5px 5px 0 " + getBlockButtonVariantProp("boxShadow") + ", -6px 6px 0 " + getBlockButtonVariantProp("boxShadow") + ",\n    -7px 7px 0 " + getBlockButtonVariantProp("boxShadow") + ", -8px 8px 0 " + getBlockButtonVariantProp("boxShadow") + ",\n    -9px 9px 0 " + getBlockButtonVariantProp("boxShadow") + ", -10px 10px 0 " + getBlockButtonVariantProp("boxShadow") + ";\n";
}, getBlockButtonVariantProp("boxShadow"), getBlockButtonVariantProp("boxShadow"), getBlockButtonVariantProp("boxShadow"), getBlockButtonVariantProp("boxShadow"), getBlockButtonVariantProp("boxShadow"), getBlockButtonVariantProp("boxShadow"), getBlockButtonVariantProp("boxShadow"), getBlockButtonVariantProp("boxShadow"), getBlockButtonVariantProp("boxShadow"), getBlockButtonVariantProp("boxShadow"), getBlockButtonVariantProp("boxShadow"), function (_a) {
    var theme = _a.theme;
    return theme.colors.secondary;
}, getBlockButtonVariantProp("backgroundActive"), getBlockButtonVariantProp("boxShadowActive"), getDisabledStyles, removePointerEvents, space);
StyledBlockButton.defaultProps = {
    fullWidth: false,
    type: "button",
};
...
var BlockButton = function (_a) {
    var startIcon = _a.startIcon, endIcon = _a.endIcon, children = _a.children, external = _a.external, isLoading = _a.isLoading, disabled = _a.disabled, isActive = _a.isActive, props = __rest(_a, ["startIcon", "endIcon", "children", "external", "isLoading", "disabled", "isActive"]);
    var internalProps = external ? getExternalLinkProps() : {};
    var isDisabled = isLoading || disabled;
    return (React.createElement(StyledBlockButton, __assign({}, internalProps, props, { isActive: isActive, isLoading: isLoading, disabled: isDisabled }),
...
var IconBlockButton = styled(BlockButton)(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n  padding: 0;\n  width: ", ";\n"], ["\n  padding: 0;\n  width: ", ";\n"])), function (_a) {
    var size = _a.size;
    return (size === "sm" ? "32px" : "48px");
});
...
var Icon$b = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 16 16" }, props),
        React.createElement("circle", { cx: "8", cy: "8", r: "8", fill: "#04B781" }),
...
var rotate$1 = keyframes(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"], ["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
var spinStyle$1 = css(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  animation: ", " 2s linear infinite;\n"], ["\n  animation: ", " 2s linear infinite;\n"])), rotate$1);
var ImageIcon = styled.img(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  fill: ", ";\n\n  ", "\n  ", "\n"], ["\n  fill: ", ";\n\n  ", "\n  ", "\n"])), function (_a) {
    var theme = _a.theme, color = _a.color;
    return getThemeValue("colors." + color, color)(theme);
}, function (_a) {
    var spin = _a.spin;
...
var Icon$p = function (props) {
    return React.createElement(ImageIcon, __assign({ src: props.src, alt: "BrickChain" }, props));
};
...
var Icon$C = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 80 80" }, props),
        React.createElement("g", { clipPath: "url(#clip0)" },
            ...
            React.createElement("path", { d: "M35.9629 36.0654L46.0085 38.7571L37.0016 72.3714L26.956 69.6797L35.9629 36.0654Z", fill: "#00FFAB" }),
            React.createElement("path", { d: "M11.8535 53.0029L14.5452 42.9573L61.111 55.4346L58.4193 65.4802L11.8535 53.0029Z", fill: "#00FFAB" }),
            React.createElement("g", { style: { mixBlendMode: "multiply" } },
                React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M30.0918 57.9047L40.1732 60.606L39.7591 62.1515L29.6777 59.4502L30.0918 57.9047ZM42.8724 50.5325L32.791 47.8312L33.2051 46.2857L43.2865 48.987L42.8724 50.5325Z", fill: "#00FFAB" })),
            ...
            React.createElement("path", { d: "M31.4707 20.8506L41.5163 18.1589L45.1398 31.6818L35.0942 34.3735L31.4707 20.8506Z", fill: "#00FFAB" }),
            React.createElement("g", { style: { mixBlendMode: "multiply" } },
                React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M31.9671 22.5998L41.9672 19.7998L41.5673 17.9998L31.3975 20.8215L31.9671 22.5998Z", fill: "#00FFAB" }))),
        React.createElement("defs", null,
...
var CloseHandler = styled.div(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  // border-radius: 0 16px 16px 0;\n  right: 8px;\n  position: absolute;\n  top: 8px;\n"], ["\n  // border-radius: 0 16px 16px 0;\n  right: 8px;\n  position: absolute;\n  top: 8px;\n"])));
...
var Alert = function (_a) {
    ...
    return (React.createElement(StyledAlert, null,
        ...
        React.createElement(Details, { hasHandler: !!onClick },
            React.createElement(Text, { bold: true, textTransform: "uppercase" }, title),
            typeof children === "string" ? React.createElement(Text, { as: "p" }, children) : children),
        onClick && (React.createElement(CloseHandler, null,
            React.createElement(IconBlockButton, { size: "sm", variant: "text", onClick: onClick },
                React.createElement(Icon$j, { width: "24px", color: "currentColor" }))))));
};
var templateObject_1$7, templateObject_2$2, templateObject_3$2, templateObject_4;
...
var StyledButton = styled.button(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n  align-items: center;\n  background-blend-mode: multiply;\n  background-color: ", ";\n  border: ", ";\n  // border-radius: 16px;\n  box-shadow: ", ";\n  color: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  height: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  transition: background-color 0.2s;\n  opacity: ", ";\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background-color: ", ";\n    border-color: ", ";\n  }\n\n  &:focus:not(:active) {\n    // box-shadow: 0 0 0 2px ", ";\n  }\n\n  &:active {\n    background-color: ", ";\n    box-shadow: ", ";\n  }\n\n  ", "\n  ", "\n  ", "\n"], ["\n  align-items: center;\n  background-blend-mode: multiply;\n  background-color: ", ";\n  border: ", ";\n  // border-radius: 16px;\n  box-shadow: ", ";\n  color: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  height: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  transition: background-color 0.2s;\n  opacity: ", ";\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background-color: ", ";\n    border-color: ", ";\n  }\n\n  &:focus:not(:active) {\n    // box-shadow: 0 0 0 2px ", ";\n  }\n\n  &:active {\n    background-color: ", ";\n    box-shadow: ", ";\n  }\n\n  ", "\n  ", "\n  ", "\n"])), getButtonVariantProp("background"), getButtonVariantProp("border"), getButtonVariantProp("boxShadow"), getButtonVariantProp("color"), function (_a) {
    ...
    var theme = _a.theme;
    return theme.colors.secondary;
}, getButtonVariantProp("backgroundActive"), getButtonVariantProp("boxShadowActive"), getDisabledStyles$1, removePointerEvents$1, space);
...
var StyledBlockButtonMenu = styled.div(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["\n  background-color: ", ";\n  display: inline-flex;\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  & > button + button,\n  & > a + a {\n    margin-left: 6px; // To avoid focus shadow overlap\n  }\n"], ["\n  background-color: ", ";\n  display: inline-flex;\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  & > button + button,\n  & > a + a {\n    margin-left: 6px; // To avoid focus shadow overlap\n  }\n"])), getBackgroundColor$1, getBackgroundColor$1);
var templateObject_1$d;

var BlockButtonMenu = function (_a) {
    ...
    return (React.createElement(StyledBlockButtonMenu, { variant: variant }, Children.map(children, function (child, index) {
        return cloneElement(child, {
            isActive: activeIndex === index,
            onClick: onClick ? function () { return onClick(index); } : undefined,
            size: size,
...
var InactiveButton$1 = styled(BlockButton)(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["\n  // background-color: transparent;\n\n  color: ", ";\n\n  &:hover {\n    background-color: #000 !important;\n  }\n\n  // &:hover:not(:disabled):not(:active) {\n  //   background-color: transparent;\n  // }\n"], ["\n  // background-color: transparent;\n\n  color: ", ";\n\n  &:hover {\n    background-color: #000 !important;\n  }\n\n  // &:hover:not(:disabled):not(:active) {\n  //   background-color: transparent;\n  // }\n"])), function (_a) {
    var theme = _a.theme, colorKey = _a.colorKey;
    return theme.colors[colorKey];
});
var BlockButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React.createElement(InactiveButton$1, __assign({ forwardedAs: as, size: size, variant: "tertiary", colorKey: variant === variants.PRIMARY ? "primary" : "textSubtle" }, props)));
    }
    return React.createElement(BlockButton, __assign({ as: as, size: size, variant: variant }, props));
};
...
var StyledCard = styled.div(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["\n  background-color: ", ";\n  border: ", ";\n  // box-shadow: ", ";\n  border-left: 10px solid ", ";\n  color: ", ";\n  overflow: hidden;\n  position: relative;\n\n  ", "\n"], ["\n  background-color: ", ";\n  border: ", ";\n  // box-shadow: ", ";\n  border-left: 10px solid ", ";\n  color: ", ";\n  overflow: hidden;\n  position: relative;\n\n  ", "\n"])), function (_a) {
    ...
    var theme = _a.theme;
    return theme.card.boxShadow;
}, getBoxShadow, getBoxShadow, function (_a) {
...
var BlockCheckbox = styled.input.attrs({ type: "checkbox" })(templateObject_1$l || (templateObject_1$l = __makeTemplateObject(["\n  appearance: none;\n  overflow: hidden;\n  cursor: pointer;\n  position: relative;\n  display: inline-block;\n  height: ", ";\n  width: ", ";\n  vertical-align: middle;\n  transition: background-color 0.2s ease-in-out;\n  border: 0;\n  // border-radius: 8px;\n  border: 4px solid ", ";\n  background-color: ", ";\n  transition: all 0.2s ease;\n  transform: translate3d(0, 0, 0);\n  // box-shadow: ", ";\n\n  &:after {\n    content: \"\";\n    position: absolute;\n    border-bottom: 2px solid;\n    border-left: 2px solid;\n    border-color: transparent;\n    top: 30%;\n    left: 0;\n    right: 0;\n    width: 50%;\n    height: 25%;\n    margin: auto;\n    transform: rotate(-50deg);\n    transition: border-color 0.2s ease-in-out;\n  }\n\n  &:hover:not(:disabled):not(:checked) {\n    // box-shadow: ", ";\n    transform: translate3d(10px, -10px, 0);\n    box-shadow: 0px 0px 0 ", ",\n      -1px 1px 0 ", ", -2px 2px 0 ", ",\n      -3px 3px 0 ", ", -4px 4px 0 ", ",\n      -5px 5px 0 ", ", -6px 6px 0 ", ",\n      -7px 7px 0 ", ", -8px 8px 0 ", ",\n      -9px 9px 0 ", ", -10px 10px 0 ", ";\n  }\n\n  &:focus {\n    outline: none;\n    // box-shadow: ", ";\n  }\n\n  &:checked {\n    background-color: ", ";\n    &:after {\n      border-color: white;\n    }\n    transform: translate3d(10px, -10px, 0);\n    box-shadow: 0px 0px 0 ", ",\n      -1px 1px 0 ", ", -2px 2px 0 ", ",\n      -3px 3px 0 ", ", -4px 4px 0 ", ",\n      -5px 5px 0 ", ", -6px 6px 0 ", ",\n      -7px 7px 0 ", ", -8px 8px 0 ", ",\n      -9px 9px 0 ", ", -10px 10px 0 ", ";\n  }\n\n  &:disabled {\n    cursor: default;\n    opacity: 0.6;\n  }\n"], ["\n  appearance: none;\n  overflow: hidden;\n  cursor: pointer;\n  position: relative;\n  display: inline-block;\n  height: ", ";\n  width: ", ";\n  vertical-align: middle;\n  transition: background-color 0.2s ease-in-out;\n  border: 0;\n  // border-radius: 8px;\n  border: 4px solid ", ";\n  background-color: ", ";\n  transition: all 0.2s ease;\n  transform: translate3d(0, 0, 0);\n  // box-shadow: ", ";\n\n  &:after {\n    content: \"\";\n    position: absolute;\n    border-bottom: 2px solid;\n    border-left: 2px solid;\n    border-color: transparent;\n    top: 30%;\n    left: 0;\n    right: 0;\n    width: 50%;\n    height: 25%;\n    margin: auto;\n    transform: rotate(-50deg);\n    transition: border-color 0.2s ease-in-out;\n  }\n\n  &:hover:not(:disabled):not(:checked) {\n    // box-shadow: ", ";\n    transform: translate3d(10px, -10px, 0);\n    box-shadow: 0px 0px 0 ", ",\n      -1px 1px 0 ", ", -2px 2px 0 ", ",\n      -3px 3px 0 ", ", -4px 4px 0 ", ",\n      -5px 5px 0 ", ", -6px 6px 0 ", ",\n      -7px 7px 0 ", ", -8px 8px 0 ", ",\n      -9px 9px 0 ", ", -10px 10px 0 ", ";\n  }\n\n  &:focus {\n    outline: none;\n    // box-shadow: ", ";\n  }\n\n  &:checked {\n    background-color: ", ";\n    &:after {\n      border-color: white;\n    }\n    transform: translate3d(10px, -10px, 0);\n    box-shadow: 0px 0px 0 ", ",\n      -1px 1px 0 ", ", -2px 2px 0 ", ",\n      -3px 3px 0 ", ", -4px 4px 0 ", ",\n      -5px 5px 0 ", ", -6px 6px 0 ", ",\n      -7px 7px 0 ", ", -8px 8px 0 ", ",\n      -9px 9px 0 ", ", -10px 10px 0 ", ";\n  }\n\n  &:disabled {\n    cursor: default;\n    opacity: 0.6;\n  }\n"])), getScale$1, getScale$1, function (_a) {
    var theme = _a.theme;
...
var templateObject_1$m, templateObject_2$4;
...
var Heading = styled(Text).attrs({ bold: true })(templateObject_1$n || (templateObject_1$n = __makeTemplateObject(["\n  font-size: ", ";\n  font-weight: 600;\n  line-height: 1.1;\n\n  ", " {\n    font-size: ", ";\n  }\n"], ["\n  font-size: ", ";\n  font-weight: 600;\n  line-height: 1.1;\n\n  ", " {\n    font-size: ", ";\n  }\n"])), function (_a) {
    var size = _a.size;
    return style[size || sizes$2.MD].fontSize;
}, function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.lg;
}, function (_a) {
    var size = _a.size;
    return style[size || sizes$2.MD].fontSizeLg;
});
...
var Wrapper = styled.div(templateObject_1$o || (templateObject_1$o = __makeTemplateObject(["\n  position: relative;\n  background-position: center center;\n  background-repeat: no-repeat;\n  background-size: cover;\n  height: ", "px;\n  max-width: ", "px;\n  max-height: ", "px;\n  width: 100%;\n  padding-top: ", "%;\n  ", "\n"], ["\n  position: relative;\n  background-position: center center;\n  background-repeat: no-repeat;\n  background-size: cover;\n  height: ", "px;\n  max-width: ", "px;\n  max-height: ", "px;\n  width: 100%;\n  padding-top: ", "%;\n  ", "\n"])), function (_a) {
...
// 	}
// `;
var Container$1 = styled.div(templateObject_1$y || (templateObject_1$y = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
var LegoSpinner = styled.div(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n  height: ", ";\n  width: ", ";\n  background: url(", ");\n  background-size: cover;\n  background-position: center;\n"], ["\n  height: ", ";\n  width: ", ";\n  background: url(", ");\n  background-size: cover;\n  background-position: center;\n"])), function (props) { return props.height; }, function (props) { return props.width; }, function (props) { return props.url; });
var Spinner = function (_a) {
    var props = __rest(_a, []);
    return (React.createElement(Container$1, null,
        React.createElement(LegoSpinner, __assign({}, props))));
};
Spinner.defaultProps = {
    height: "200px",
    width: "200px",
};
var templateObject_1$y, templateObject_2$7;
...
var templateObject_1$z, templateObject_2$8, templateObject_3$3, templateObject_4$1, templateObject_5;
...
var templateObject_1$A, templateObject_2$9, templateObject_3$4;
...
var shadows = {
    ...
    active: "0 0 0 2px #14C38E",
    // success: "0px 0px 0px 1px #31D0AA, 0px 0px 0px 4px rgba(49, 208, 170, 0.2)",
    success: "0 0 0 2px #CC9544",
    // warning: "0px 0px 0px 1px #ED4B9E, 0px 0px 0px 4px rgba(237, 75, 158, 0.2)",
    warning: "0 0 0 2px #F87575",
    // focus: "0px 0px 0px 1px #00FFAB, 0px 0px 0px 4px rgba(118, 69, 217, 0.6)",
    // focus: "0 0 0 2px #36AE7C",
    focus: "0 0 0 2px #14C38E",
    ...
    return (React.createElement(StyledModal, null,
        React.createElement(ModalHeader, null,
            React.createElement(ModalTitle, null,
                onBack && (React.createElement(IconBlockButton, { size: "sm", variant: "secondary", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React.createElement(Icon$5, { color: "secondaryDark" }))),
                React.createElement(Heading, null, title)),
            !hideCloseButton && (React.createElement(IconBlockButton, { size: "sm", variant: "secondary", onClick: onDismiss, "aria-label": "Close the dialog" },
                React.createElement(Icon$j, { color: "secondaryDark" })))),
...
var Icon$D = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 480 480" }, props),
        React.createElement("path", { "data-name": "layer2", d: `M114.558,242.929C93.885,263.602,82.5,291.128,82.5,320.436c0,29.308,11.385,56.833,32.057,77.505
        ...
        React.createElement("path", { "data-name": "layer1", d: `M377.5,150h-40.847c-4.228-25.086-24.066-44.94-49.153-49.167V0h-220v100.833
...
var Icon$E = function (props) {
    return (React.createElement(Svg, __assign({}, props, { viewBox: "0 0 64 64" }),
...
var Icon$I = function (props) {
    return (React.createElement(Svg, __assign({}, props, { viewBox: "0 0 58.365 58.365" }),
        React.createElement("path", { "data-name": "layer1", d: `M57.863,26.632l-8.681-8.061V5.365h-10v3.921L29.182,0L0.502,26.632c-0.404,0.376-0.428,1.009-0.052,1.414
...
var Icon$M = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React.createElement("path", { "data-name": "layer1", d: "M32 10a22 22 0 1 0 22 22 22 22 0 0 0-22-22zm0 40a17.9 17.9 0 0 1-5-.7 18 18 0 0 0 0-34.6A18 18 0 1 1 32 50z" })));
};
...
var Icon$P = function (props) {
    return (React.createElement(Svg, __assign({}, props, { viewBox: "0 0 297 297" }),
        React.createElement("path", { "data-name": "layer1", d: `M218.957,140.08c4.536-1.956,8.786-4.772,12.486-8.471c26.629-26.63,24.507-70.285,24.404-72.131
...
var Icon$Q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React.createElement("circle", { "data-name": "layer2", cx: "32", cy: "32", r: "15" }),
        React.createElement("path", { "data-name": "layer1", d: "M32 12a2 2 0 0 0 2-2V2a2 2 0 0 0-4 0v8a2 2 0 0 0 2 2zm0 40a2 2 0 0 0-2 2v8a2 2 0 0 0 4 0v-8a2 2 0 0 0-2-2zm30-22h-8a2 2 0 1 0 0 4h8a2 2 0 0 0 0-4zm-50 2a2 2 0 0 0-2-2H2a2 2 0 0 0 0 4h8a2 2 0 0 0 2-2zm3-14.1a2 2 0 1 0 2.9-2.9l-5.7-5.6a2 2 0 1 0-2.8 2.8zm34 28.2a2 2 0 0 0-2.9 2.9l5.7 5.7a2 2 0 1 0 2.8-2.8zm-1.4-27.7a2 2 0 0 0 1.4-.6l5.7-5.7a2 2 0 1 0-2.8-2.8L46.1 15a2 2 0 0 0 1.4 3.4zM15 46.1l-5.6 5.7a2 2 0 1 0 2.8 2.8l5.7-5.6a2 2 0 0 0-2.9-2.9z" })));
};
...
var Icon$T = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React.createElement("path", { "data-name": "layer2", d: "M47 37.7l13.8-4.6L47 28.5l-13.8 4.6L47 37.7zm2 3.6v18.2l15-5V36.3l-15 5zm-4 0l-15-5v18.2l15 5V41.3zm-32-6.7l9.8-3.3-9.8-3.2-9.8 3.2 9.8 3.3zm-2 3.6L0 34.5V48l11 3.7V38.2zm4 0v13.5L26 48V34.5l-11 3.7z" }),
        React.createElement("path", { "data-name": "layer1", d: "M31 11l9.9-3.3L31 4.5l-9.8 3.2L31 11zm-2 3.6l-11-3.7v13.5l11 3.7V14.6zm4 0v13.5l11-3.7V10.9l-11 3.7z" })));
};

var Icon$U = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React.createElement("path", { "data-name": "layer2", d: "M0 1v6h13v33H0v23h19V1zm9 54a4 4 0 1 1 4-4 4 4 0 0 1-4 4z" }),
        React.createElement("path", { "data-name": "layer2", d: "M0 11h9v25H0zM23 1v6h13v33H23v23h19V1zm9 54a4 4 0 1 1 4-4 4 4 0 0 1-4 4z" }),
        React.createElement("path", { "data-name": "layer2", d: "M23 11h9v25h-9z" }),
        React.createElement("path", { "data-name": "layer1", d: "M46 1v6h13v33H46v23h18V1zm9 54a4 4 0 1 1 4-4 4 4 0 0 1-4 4z" }),
        React.createElement("path", { "data-name": "layer1", d: "M46 11h9v25h-9z" })));
};

var Icon$V = function (props) {
    return (React.createElement(Svg, __assign({}, props, { viewBox: "0 0 64 64" }),
        React.createElement("path", { "data-name": "layer2", d: "M12 15h18.109l-3.102 2.758 3.986 4.485L42.516 12 30.993 2l-3.986 4.243L30.109 9H6v46h11v-6h-5V15z" }),
        React.createElement("path", { "data-name": "layer1", d: "M60 9H49v6h5v34H35.891l3.102-2.757-3.986-4.485L23.484 52 35 62l3.993-4.242L35.891 55H60V9z" })));
};
...
var MenuBlockButton = styled(BlockButton)(templateObject_1$E || (templateObject_1$E = __makeTemplateObject(["\n  color: ", ";\n  margin-left: 3px;\n  margin-right: 16px;\n"], ["\n  color: ", ";\n  margin-left: 3px;\n  margin-right: 16px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.secondaryDark;
});
MenuBlockButton.defaultProps = {
    variant: "secondary",
    size: "sm",
};
var templateObject_1$E;
...
var Logo$1 = function (_a) {
    var isPushed = _a.isPushed, togglePush = _a.togglePush, logoUrl = _a.logoUrl, href = _a.href, brickPriceUsd = _a.brickPriceUsd, brickPriceLinkUrl = _a.brickPriceLinkUrl, isMobile = _a.isMobile;
    var isAbsoluteUrl = href.startsWith("http");
    var innerLogo = !isMobile && logoUrl ? React.createElement(Icon$p, { src: logoUrl }) : null;
    return (React.createElement(Flex, null,
        React.createElement(MenuBlockButton, { "aria-label": "Toggle menu", onClick: togglePush }, isPushed ? (React.createElement(Icon$H, { width: "24px", color: "secondaryDark" })) : (React.createElement(Icon$G, { width: "24px", color: "secondaryDark" }))),
        brickPriceUsd && brickPriceLinkUrl ? (isAbsoluteUrl ? (React.createElement(Link, { external: true, href: brickPriceLinkUrl !== null && brickPriceLinkUrl !== void 0 ? brickPriceLinkUrl : "/", "aria-label": "Brickchain contract" },
            React.createElement(BlockButton, { variant: "secondary", size: "sm", startIcon: innerLogo, as: "a", "aria-label": "Brickchain contract" },
                React.createElement(Text, { color: "secondaryDark", bold: true }, "$" + brickPriceUsd.toFixed(3))))) : (React.createElement(Link, { external: true, href: brickPriceLinkUrl !== null && brickPriceLinkUrl !== void 0 ? brickPriceLinkUrl : "/", "aria-label": "Brickchain contract" },
            React.createElement(BlockButton, { variant: "secondary", size: "sm", startIcon: innerLogo, "aria-label": "Brickchain contract" },
                React.createElement(Text, { color: "secondaryDark", bold: true }, "$" + brickPriceUsd.toFixed(3)))))) : null));
};
...
var links = [
    ...
    },
    {
        ...
        items: [
            {
                label: "Exchange",
                href: "https://exchange.brickchain.finance",
            },
            {
                label: "Liquidity",
                href: "https://exchange.brickchain.finance/#/pool",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        items: [
            {
                label: "Overview",
                href: "https://brickchain.info",
            },
            {
                label: "Tokens",
                href: "https://brickchain.info/tokens",
            },
            {
                label: "Pairs",
                href: "https://brickchain.info/pairs",
            },
            {
                label: "Accounts",
                href: "https://brickchain.info/accounts",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        items: [
            {
                label: "Voting",
                href: "https://voting.brickchain.finance",
            },
            {
                label: "Github",
                href: "https://github.com/brickchain",
            },
            {
                label: "Docs",
                href: "https://docs.brickchain.finance",
            },
            {
                label: "Blog",
                href: "https://brickchain.medium.com",
            },
        ],
    },
];
var socials = [
    {
        ...
        items: [
            {
                label: "Global",
                href: "https://t.me/limeswapfinance",
            }
        ],
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/limeswapfinance",
    },
];
var MENU_HEIGHT = 64;
...
var SIDEBAR_BLOCK_WIDTH_REDUCED = 95;
...
var LinkLabel = styled.div(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  color: ", ";\n  transition: color 0.4s;\n  flex-grow: 1;\n"], ["\n  color: ", ";\n  transition: color 0.4s;\n  flex-grow: 1;\n"])), function (_a) {
    var isPushed = _a.isPushed, color = _a.color;
...
var templateObject_1$F, templateObject_2$b, templateObject_3$6;
...
var SubContainer = styled.div(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n  margin-top: auto;\n"], ["\n  margin-top: auto;\n"])));
var PanelBodyList = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, isMobile = _a.isMobile, links = _a.links; _a.isDark;
    var location = useLocation();
    // Close the menu when a user clicks a link on mobile
    var handleClick = isMobile ? function () { return pushNav(false); } : undefined;
    var ButtonType = isPushed ? BlockButton : IconBlockButton;
    var _b = partition(links, "secondary"), secondaryLinks = _b[0], primaryLinks = _b[1];
    return (React.createElement(Container$2, null,
        primaryLinks.map(function (entry) {
            var Icon = Icons[entry.icon];
            var iconElement = React.createElement(Icon, { width: "24px", mr: "8px", color: "secondaryDark", fill: "secondaryDark" });
            return isPushed ? (React.createElement(MenuLink, { key: entry.href, href: entry.href, onClick: handleClick },
                React.createElement(ButtonType, { isActive: entry.href === location.pathname, mb: "10px", startIcon: iconElement, variant: "secondary", fullWidth: true },
                    React.createElement(LinkLabel, { color: "secondaryDark", isPushed: isPushed }, entry.label)))) : (React.createElement(MenuLink, { key: entry.href, href: entry.href, onClick: handleClick },
                React.createElement(IconBlockButton, { isActive: entry.href === location.pathname, mb: "10px", href: entry.href, variant: "secondary", onClick: handleClick },
                    React.createElement(Icon, { width: "24px", color: "secondaryDark", fill: "secondaryDark" }))));
        }),
        React.createElement(SubContainer, null, secondaryLinks.map(function (entry) {
            var Icon = Icons[entry.icon];
            var iconElement = React.createElement(Icon, { width: "24px", mr: "8px", color: "secondaryDark", fill: "secondaryDark" });
            return isPushed ? (React.createElement(MenuLink, { key: entry.href, href: entry.href, onClick: handleClick },
                React.createElement(ButtonType, { isActive: entry.href === location.pathname, mb: "10px", startIcon: iconElement, variant: "secondary", fullWidth: true },
...
var Container$3 = styled.div(templateObject_1$H || (templateObject_1$H = __makeTemplateObject(["\n  flex: none;\n  padding: 8px 4px;\n  background-color: ", ";\n  border-top: ", ";\n"], ["\n  flex: none;\n  padding: 8px 4px;\n  background-color: ", ";\n  border-top: ",
    ...
    var isMenuList = _a.isMenuList, theme = _a.theme;
    return isMenuList ? "4px solid " + theme.colors.secondaryDark : "2px solid rgba(133, 133, 133, 0.1)";
});
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, toggleTheme = _a.toggleTheme, isDark = _a.isDark; _a.brickPriceUsd; _a.brickPriceLinkUrl; _a.logoUrl; _a.currentLang; _a.langs; _a.setLang; var isMenuList = _a.isMenuList, _b = _a.noSwitchThemes, noSwitchThemes = _b === void 0 ? false : _b;
    if (!isPushed) {
        return (React.createElement(Container$3, { isMenuList: isMenuList }, isMenuList ? (React.createElement(IconBlockButton, { m: "16px", variant: "secondary", onClick: function () { return pushNav(true); } },
            React.createElement(Icon$k, null))) : (React.createElement(IconButton, { variant: "text", onClick: function () { return pushNav(true); } },
            React.createElement(Icon$k, null)))));
    }
    return (React.createElement(Container$3, { isMenuList: isMenuList },
        React.createElement(SocialEntry, null,
            !noSwitchThemes && (React.createElement(BlockButton, { variant: "secondary", size: "sm", onClick: function () { return toggleTheme(!isDark); } },
                React.createElement(Flex, { alignItems: "center" },
                    React.createElement(SunIcon, { color: isDark ? "textDisabled" : "secondaryDark", fill: isDark ? "textDisabled" : "secondaryDark", width: "18px" }),
                    React.createElement(Text, { color: "textDisabled", mx: "4px" }, "/"),
                    React.createElement(MoonIcon, { color: isDark ? "secondaryDark" : "textDisabled", fill: isDark ? "secondaryDark" : "textDisabled", width: "18px" })))),
            React.createElement(Flex, null, socials.map(function (social, index) {
                var Icon = Icons$1[social.icon];
                var iconProps = { width: "24px", color: "secondaryDark", style: { cursor: "pointer" } };
                var mr = index < socials.length - 1 ? "24px" : 0;
                if (social.items) {
                    return (React.createElement(Dropdown, { key: social.label, position: "top", target: React.createElement(IconBlockButton, { size: "sm", mr: "10px", variant: "secondary", key: social.label, href: social.href, "aria-label": social.label },
                            React.createElement(Icon, __assign({}, iconProps))) }, social.items.map(function (item) { return (React.createElement(Link, { external: true, key: item.label, href: item.href, "aria-label": item.label, color: "secondaryDark" }, item.label)); })));
                }
                return (React.createElement(Link, { external: true, key: social.label, href: social.href, "aria-label": social.label, mr: mr },
                    React.createElement(IconBlockButton, { size: "sm", variant: "secondary", key: social.label, href: social.href, "aria-label": social.label, mr: mr },
...
var StyledPanel = styled.div(templateObject_1$I || (templateObject_1$I = __makeTemplateObject(["\n  position: fixed;\n  padding-top: ", ";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: ", ";\n  height: 100vh;\n  transition: padding-top 0.2s, width 0.2s;\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-right: ", ";\n    width: ", ";\n  }\n\n  ", "\n"], ["\n  position: fixed;\n  padding-top: ", ";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: ", ";\n  height: 100vh;\n  transition: padding-top 0.2s, width 0.2s;\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-right: ",
    ...
    var isPushed = _a.isPushed, isMenuList = _a.isMenuList;
    return (isPushed ? SIDEBAR_WIDTH_FULL : isMenuList ? SIDEBAR_BLOCK_WIDTH_REDUCED : SIDEBAR_WIDTH_REDUCED) + "px";
}, function (_a) {
    var isMenuList = _a.isMenuList, theme = _a.theme;
    return isMenuList &&
        "border-right: 4px solid " + theme.colors.secondaryDark + ";\n    ";
});
var Panel = function (props) {
    var isPushed = props.isPushed, showMenu = props.showMenu, isMenuList = props.isMenuList;
    return (React.createElement(StyledPanel, { isPushed: isPushed, isMenuList: isMenuList, showMenu: showMenu },
        React.createElement(PanelBodyList, __assign({}, props)),
...
var Icon$10 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        ...
        React.createElement("path", { d: "M16.2857 4L9.97035 7.6761L12.2922 9.03415L16.2857 6.7161L20.2792 9.03415L22.6011 7.6761L16.2857 4Z", fill: "#04B781" }),
        React.createElement("path", { d: "M20.2792 10.9541L22.6011 12.3122V15.0283L18.6075 17.3463V21.9824L16.2857 23.3405L13.9639 21.9824V17.3463L9.97035 15.0283V12.3122L12.2922 10.9541L16.2857 13.2722L20.2792 10.9541Z", fill: "#04B781" }),
        React.createElement("path", { d: "M22.6011 16.9483V19.6644L20.2792 21.0224V18.3063L22.6011 16.9483Z", fill: "#04B781" }),
        React.createElement("path", { d: "M20.2561 22.9424L24.2496 20.6244V15.9883L26.5714 14.6302V21.9824L20.2561 25.6585V22.9424Z", fill: "#04B781" }),
        React.createElement("path", { d: "M24.2496 11.3522L21.9278 9.99414L24.2496 8.63609L26.5714 9.99414V12.7102L24.2496 14.0683V11.3522Z", fill: "#04B781" }),
        React.createElement("path", { d: "M13.9639 26.642V23.9259L16.2857 25.2839L18.6075 23.9259V26.642L16.2857 28L13.9639 26.642Z", fill: "#04B781" }),
        React.createElement("path", { d: "M12.2922 21.0224L9.97035 19.6644V16.9483L12.2922 18.3063V21.0224Z", fill: "#04B781" }),
        React.createElement("path", { d: "M16.2857 11.3522L13.9639 9.99414L16.2857 8.63609L18.6075 9.99414L16.2857 11.3522Z", fill: "#04B781" }),
        React.createElement("path", { d: "M10.6437 9.99414L8.32183 11.3522V14.0683L6 12.7102V9.99414L8.32183 8.63609L10.6437 9.99414Z", fill: "#04B781" }),
        React.createElement("path", { d: "M6 14.6302L8.32183 15.9883V20.6244L12.3154 22.9424V25.6585L6 21.9824V14.6302Z", fill: "#04B781" })));
};
...
var WalletCard = function (_a) {
    ...
    return (React.createElement(BlockButton, { fullWidth: true, variant: "secondary", onClick: function () {
            login(walletConfig.connectorId);
            window.localStorage.setItem(localStorageKey, "1");
            onDismiss();
        }, style: { justifyContent: "space-between" }, mb: mb, id: "wallet-connect-" + title.toLocaleLowerCase() },
        React.createElement(Text, { bold: true, color: "secondaryDark", mr: "16px" }, title),
        React.createElement(Icon, { width: "32px" })));
};

var HelpLink = styled(Link)(templateObject_1$J || (templateObject_1$J = __makeTemplateObject(["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 24px;\n"], ["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 24px;\n"])));
var ConnectModal = function (_a) {
    var login = _a.login, helpUrl = _a.helpUrl, _b = _a.onDismiss, onDismiss = _b === void 0 ? function () { return null; } : _b;
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: helpUrl || "https://brick-token-documentation.gitbook.io/brickchain-finance/faq/how-to-use-metamask-on-brick", external: true },
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React.createElement(Flex, { mb: "32px" },
            React.createElement(LinkExternal, { textTransform: "uppercase", small: true, href: "https://blockexplorer.boba.network/address/" + account, mr: "16px" }, "View on Boba Explorer"),
            React.createElement(CopyToClipboard, { textTransform: "uppercase", toCopy: account }, "Copy Address")),
        React.createElement(Flex, { justifyContent: "right" },
            React.createElement(BlockButton, { variant: "secondary", onClick: function () {
                    logout();
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(BlockButton, { size: "sm", variant: "secondary", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React.createElement(BlockButton, { size: "sm", onClick: function () {
...
var Avatar = function (_a) {
    ...
    image ? React.createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" }) : null;
    if (isExternal) {
...
var Inner = styled.div(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  flex-grow: 1;\n  margin-top: ", ";\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n  max-width: 100%;\n\n  ", " {\n    margin-left: ", ";\n    max-width: ", ";\n  }\n"], ["\n  flex-grow: 1;\n  margin-top: ", ";\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n  max-width: 100%;\n\n  ", " {\n    margin-left: ",
    ...
    var isPushed = _a.isPushed, isMenuList = _a.isMenuList;
    return "calc(100% - " + (isPushed ? SIDEBAR_WIDTH_FULL : isMenuList ? SIDEBAR_BLOCK_WIDTH_REDUCED : SIDEBAR_WIDTH_REDUCED) + "px)";
});
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, logoUrl = _a.logoUrl, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, brickPriceUsd = _a.brickPriceUsd, brickPriceLinkUrl = _a.brickPriceLinkUrl, links = _a.links, profile = _a.profile, children = _a.children, _c = _a.noSwitchThemes, noSwitchThemes = _c === void 0 ? false : _c, _d = _a.isMenuList, isMenuList = _d === void 0 ? true : _d;
    var isXl = useMatchBreakpoints().isXl;
    var isMobile = isXl === false;
    var _e = useState(!isMobile), isPushed = _e[0], setIsPushed = _e[1];
    ...
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, { showMenu: showMenu, isMenuList: isMenuList },
            React.createElement(Logo$1, { isMenuList: isMenuList, isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, logoUrl: logoUrl, isMobile: isMobile, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/", brickPriceUsd: brickPriceUsd, brickPriceLinkUrl: brickPriceLinkUrl }),
            React.createElement(Flex, null,
                React.createElement(UserBlock, { account: account, login: login, logout: logout }),
                profile && React.createElement(Avatar, { profile: profile }))),
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, brickPriceUsd: brickPriceUsd, pushNav: setIsPushed, links: links, logoUrl: logoUrl, isMenuList: isMenuList, brickPriceLinkUrl: brickPriceLinkUrl, noSwitchThemes: noSwitchThemes }),
            React.createElement(Inner, { isPushed: isPushed, showMenu: showMenu, isMenuList: isMenuList }, children),
...
var baseColors = {
    failure: "#F87575",
    primary: "#fbcd02",
    primaryBright: "#FDD835",
    primaryDark: "#F0B90B",
    secondary: "#7645D9",
    success: "#7CBD1E",
    warning: "#FFB237",
    secondaryDark: "#83BD75",
};
var brandColors = {
    binance: "#F0B90B",
};
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#83BD750a", backgroundDisabled: "#E9EAEB", contrast: "#B4FF9F", invertedContrast: "#FFFFFF", input: "#eff5fa", tertiary: "#EFF4F5", text: "#0D1821", textDisabled: "#BDC2C4", textSubtle: "#a5b6c3", borderColor: "#B4FF9F", card: "#FFFFFF", gradients: {
    bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
} });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { primary: "#e0d39a", secondary: "#885A89", secondaryDark: "#B4FF9F", background: "#100C18", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#666171", text: "#e0d39a", textDisabled: "#666171", textSubtle: "#B4FF9F", borderColor: "#B4FF9F", card: "#27262c", gradients: {
...
var light$1 = (_a$2 = {},
    ...
    _a$2[DANGER] = {
        ...
        backgroundActive: "#F65151",
        backgroundHover: "#FA9393",
        border: 0,
        borderColorHover: "currentColor",
        boxShadow: "none",
        boxShadowActive: "none",
...
var _a$3, _b$1;
var PRIMARY$1 = variants.PRIMARY, SECONDARY$1 = variants.SECONDARY, TERTIARY$1 = variants.TERTIARY, TEXT$1 = variants.TEXT, DANGER$1 = variants.DANGER, SUBTLE$1 = variants.SUBTLE, SUCCESS$1 = variants.SUCCESS;
var light$2 = (_a$3 = {},
    _a$3[PRIMARY$1] = {
        background: "transparent",
        backgroundActive: lightColors.primaryDark,
        backgroundHover: lightColors.primaryBright,
        border: "4px solid " + lightColors.primary,
        borderColorHover: "currentColor",
    ...
    _a$3[SECONDARY$1] = {
        ...
        backgroundActive: "transparent",
        backgroundHover: "transparent",
        border: "4px solid " + lightColors.secondaryDark,
        borderColorHover: lightColors.primaryBright,
        boxShadow: lightColors.secondaryDark,
        boxShadowActive: "none",
        color: lightColors.secondaryDark,
    },
    _a$3[TERTIARY$1] = {
        ...
        backgroundActive: lightColors.tertiary,
        backgroundHover: lightColors.tertiary,
        border: "4px solid " + lightColors.tertiary,
        borderColorHover: "currentColor",
        boxShadow: lightColors.tertiary,
        boxShadowActive: "none",
        color: lightColors.secondaryDark,
    },
    _a$3[TEXT$1] = {
    ...
    _a$3[DANGER$1] = {
        ...
        backgroundActive: "#F65151",
        backgroundHover: "#FA9393",
        border: "4px solid " + lightColors.failure,
        borderColorHover: "currentColor",
        boxShadow: lightColors.failure,
        boxShadowActive: "none",
        color: lightColors.secondaryDark,
    },
    _a$3[SUBTLE$1] = {
        ...
        backgroundActive: lightColors.textSubtle + "D9",
        backgroundHover: lightColors.textSubtle + "B3",
        border: "4px solid " + lightColors.textSubtle,
        borderColorHover: "currentColor",
        boxShadow: lightColors.textSubtle,
        boxShadowActive: "none",
        color: lightColors.secondaryDark,
    },
    _a$3[SUCCESS$1] = {
        ...
        backgroundActive: lightColors.success + "D9",
        backgroundHover: lightColors.success + "B3",
        border: "4px solid " + lightColors.success,
        borderColorHover: "currentColor",
        boxShadow: lightColors.success,
        boxShadowActive: "none",
        color: lightColors.secondaryDark,
    },
    _a$3);
var dark$2 = (_b$1 = {},
    _b$1[PRIMARY$1] = __assign(__assign({}, light$2.primary), { backgroundActive: darkColors.primary, backgroundHover: darkColors.primary, border: "4px solid " + darkColors.primary, boxShadow: darkColors.primary, color: darkColors.primary }),
    _b$1[SECONDARY$1] = __assign(__assign({}, light$2.secondary), { backgroundActive: darkColors.secondaryDark, backgroundHover: darkColors.secondaryDark, border: "4px solid " + darkColors.secondaryDark, boxShadow: darkColors.secondaryDark, color: darkColors.secondaryDark }),
    _b$1[TERTIARY$1] = __assign(__assign({}, light$2.tertiary), { backgroundActive: darkColors.tertiary, backgroundHover: darkColors.tertiary, border: "4px solid " + darkColors.tertiary, boxShadow: darkColors.tertiary, color: darkColors.tertiary }),
    _b$1[TEXT$1] = __assign(__assign({}, light$2.text), { backgroundActive: darkColors.text, backgroundHover: darkColors.text, border: "4px solid " + darkColors.text, boxShadow: darkColors.text, color: darkColors.text }),
    _b$1[DANGER$1] = __assign(__assign({}, light$2.danger), { color: darkColors.secondaryDark }),
    _b$1[SUBTLE$1] = __assign(__assign({}, light$2.subtle), { color: darkColors.secondaryDark }),
    _b$1[SUCCESS$1] = __assign(__assign({}, light$2.success), { color: darkColors.secondaryDark }),
    _b$1);
...
var darkTheme = __assign(__assign({}, base), { isDark: true, alert: dark, button: dark$1, blockButton: dark$2, colors: darkColors, card: dark$3, toggle: dark$5, nav: dark$6, modal: dark$7, radio: dark$4 });

var lightTheme = __assign(__assign({}, base), { isDark: false, alert: light, button: light$1, blockButton: light$2, colors: lightColors, card: light$3, toggle: light$5, nav: light$6, modal: light$7, radio: light$4 });

export { Icon$4 as AddIcon, Alert, Icon$5 as ArrowBackIcon, Icon$6 as ArrowDownIcon, Icon$7 as ArrowDropDownIcon, Icon$8 as ArrowDropUpIcon, Icon$9 as ArrowForwardIcon, Icon$a as AutoRenewIcon, BackgroundImage, GridLayout as BaseLayout, Icon$b as BinanceIcon, BlockButton, BlockButtonMenu, BlockButtonMenuItem, BlockCheckbox, Icon$2 as BlockIcon, Box, Breadcrumbs, Button, ButtonMenu, ButtonMenuItem, Icon$c as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$d as CardViewIcon, GridLayout$1 as CardsLayout, Checkbox, Icon as CheckmarkCircleIcon, Icon$e as CheckmarkIcon, Icon$f as ChevronDownIcon, Icon$g as ChevronLeftIcon, Icon$h as ChevronRightIcon, Icon$i as ChevronUpIcon, Icon$j as CloseIcon, Icon$k as CogIcon, Icon$l as CommunityIcon, Icon$m as CopyIcon, Dropdown, Icon$1 as ErrorIcon, Flex, Heading, Icon$n as HelpIcon, IconBlockButton, IconButton, Image, ImageIcon, Icon$3 as InfoIcon, Input, Link, LinkExternal, Icon$o as ListViewIcon, Icon$p as LogoIcon, Menu, Icon$q as MinusIcon, Modal, ModalProvider, Icon$r as OpenNewIcon, Icon$s as PrizeIcon, Progress, Icon$t as ProgressBunny, Radio, Icon$u as RemoveIcon, ResetCSS, Icon$v as SearchIcon, Skeleton, Spinner, Svg, Icon$w as SwapVertIcon, Icon$x as SyncAltIcon, Tag, Text, Icon$y as Ticket, Icon$z as TicketRound, ToastContainer, Toggle, Icon$A as VerifiedIcon, Icon$B as WarningIcon, Icon$C as Won, variants$1 as alertVariants, byTextAscending, byTextDescending, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
